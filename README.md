...
|------|-----------|--------------|
| `canvas-outcomes-worksheet.html` | An interactive, self-contained worksheet in three parts — **Plan**, **Interpret**, **Act**. Enter real scores and watch the calculation methods disagree; generate correct reporting language; save a dated version record as PDF. | Anyone building or reading an outcome |
...
**Interactive worksheet** — open `canvas-outcomes-worksheet.html` in any browser (or visit the GitHub Pages link below). Work top to bottom:
...
4. Save. After a minute your worksheet is live at
   `https://<your-username>.github.io/<repo-name>/canvas-outcomes-worksheet.html`
